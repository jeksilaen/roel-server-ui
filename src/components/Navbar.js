...
const Navbar = () => {
  return (
    <nav className='nav bg-slate-800 text-white flex justify-between items-center p-4 shadow-xl'>
        <Link to="/" className='text-2xl font-medium font-minecraft'>myBook</Link>
...
function CustomLink({to, children, ...props}){
    ...
    return(
        <li className={isActive ? "bg-slate-400 px-5 mx-3 rounded-md" : "px-5 mx-3 hover:bg-slate-600 rounded-md"}>
